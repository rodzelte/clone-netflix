  ...
  if (!trendingContent)
    return (
      <div className="h-screen text-white relative">
        <Navbar />
        <div className="absolute top-0 left-0 w-full h-full bg-black/70 items-center flex justify-center -z-10 shimmer"></div>
      </div>
    );
  return (
    <>
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg">
              {trendingContent?.overview.length > 190
                ? trendingContent?.overview.slice(0, 190) + " ..."
